...
let FriendsPageComponent = class FriendsPageComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
let FindFriendsComponent = class FindFriendsComponent {
    constructor(friendService, siteLayoutService) {
...
FindFriendsComponent.ctorParameters = () => [
...
MyFriendsComponent.ctorParameters = () => [
    { type: _services_friend_service__WEBPACK_IMPORTED_MODULE_2__["FriendService"] },
    { type: _services_site_layout_service__WEBPACK_IMPORTED_MODULE_3__["SiteLayoutService"] }
];
...
let SiteLayoutService = class SiteLayoutService {
    constructor(http) {
        this.http = http;
...
SiteLayoutService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SiteLayoutComponent = class SiteLayoutComponent {
    constructor(auth, siteLayoutService) {
        this.auth = auth;
        this.siteLayoutService = siteLayoutService;
        this.fileData = null;
